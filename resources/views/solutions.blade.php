            ...
            <div class="signup-content">
                ...
                <div class="signup-form solution_all register-form">
                    ...
                    <div class="all_solutions">
                        ...
                        <a href="{{ route('solve_need', $purpose->id) }}" class="solution-link">
                            <div class="card card-body solution_cards">
                                <div class="row">
                                    <div class="col-md-4 col-5">
                                        @if(isset($purpose->image))
                                        <img class="solutions_image" src="{{ asset('storage/' . $purpose->image) }}"
                                            alt="">
                                        ...
                                        <p class="mt-2">{{ $purpose->created_at->diffForHumans() }}</p>
                                    </div>
                                    <div class="col-md-8 col-7 padding-left-none">
                                        <h3 class="card-title solution-card-title font-20 mt-0">
                                        {{ Illuminate\Support\Str::limit($purpose->title, 20) }}
                                        </h3>
                                        <div class="solution_country_count">
                                            <p class="solution_country" style="color: #848383;">
                                                {{ $purpose->user->country }} </p>
                                            <p class="solution_count" style="color: #848383;">Solutions: <span>{{ $purpose->total_solutions }}</span></p>
                                            </p>
                                        </div>

                                        <p class="card-text solution_para">
                                        {{ Illuminate\Support\Str::limit($purpose->description, 30) }}
                                        </p>
                                    </div>
                                </div>
                            </div>
